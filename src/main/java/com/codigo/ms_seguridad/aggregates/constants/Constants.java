...
public class Constants {
    ...
    public static final String ENDPOINTS_PERMIT = "/api/authentication/**";
    ...
    public static final String ENDPOINTS_USER= "/api/user/**";
    public static final String ENDPOINTS_ADMIN = "/api/admin/**";
    public static final String ENDPOINTS_GESTOR_RESTAURANTE = "/api/gestor-rest/**";
    public static final String ENDPOINTS_IMAGES = "/uploads/**";
}
